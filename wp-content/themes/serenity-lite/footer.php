            ...
            <footer class="page-footer text-light">
              ...
              <?php if ( get_theme_mod( 'serenity_lite_footer_toggle' ) == '' ) : ?>
                ...
                <div class="footer-copyright text-center small bg-dimped__dark py-3">
                    ...
                    <a class="text-light" href="<?php echo esc_url( __( '', 'serenity-lite' ) ); ?>"><?php printf( __( '© 2019', 'serenity-lite' ), '' ); ?></a>

                    <span class="sep text-light mx-2"> | </span>

                    <a class="text-light" href="<?php echo esc_url( 'https://dev-pro.xyz/' ); ?>"><?php printf( __( 'Dev-Pro', 'serenity-lite' ), '' ); ?></a>
